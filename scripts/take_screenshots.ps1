...
$readUrl = "http://127.0.0.1:8000/?mode=read&issue=$issueParam&v=$dateParam&screenshot=true"
...
$editUrl = "http://127.0.0.1:8000/?mode=edit&issue=$issueParam&v=$dateParam&screenshot=true"

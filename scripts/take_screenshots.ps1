...
$readUrl = "http://127.0.0.1:8080/?mode=read&v=20260531"
$readOut = Join-Path $brainDir "render_read_mode_012.png"
...
$editUrl = "http://127.0.0.1:8080/?mode=edit&v=20260531"
$editOut = Join-Path $brainDir "render_edit_mode_012.png"
